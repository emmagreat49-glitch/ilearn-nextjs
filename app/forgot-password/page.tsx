      ...
      <div style={{ background: '#0a0e27', color: '#fff', minHeight: '100vh', fontFamily: 'Inter, sans-serif', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
        ...
        <div style={{ position: 'relative', zIndex: 2, width: '100%', maxWidth: '420px' }}>
          <div style={{ textAlign: 'center' }}>
            <div style={{ width: '64px', height: '64px', background: 'linear-gradient(135deg, rgba(139, 92, 246, 0.2) 0%, rgba(59, 130, 246, 0.15) 100%)', border: '2px solid rgba(139, 92, 246, 0.4)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 32px', fontSize: '32px' }}>
              ✓
            </div>

            <h1 style={{ fontSize: '32px', fontWeight: '800', marginBottom: '16px', letterSpacing: '-0.5px' }}>Check your email</h1>
            <p style={{ fontSize: '15px', color: '#cbd5e1', fontWeight: '500', marginBottom: '32px', lineHeight: '1.6' }}>
              We've sent password reset instructions to <strong style={{ color: '#e0e7ff' }}>{email}</strong>
            </p>

            <p style={{ fontSize: '14px', color: '#94a3b8', marginBottom: '40px' }}>
              Didn't receive it? Check your spam folder or try signing in if you remember your password.
            </p>
    ...
    <div style={{ background: '#0a0e27', color: '#fff', minHeight: '100vh', fontFamily: 'Inter, sans-serif', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
      ...
      <div style={{ position: 'relative', zIndex: 2, width: '100%', maxWidth: '420px' }}>
        <div style={{ textAlign: 'center', marginBottom: '60px' }}>
          ...
          <h1 style={{ fontSize: '32px', fontWeight: '800', marginBottom: '12px', letterSpacing: '-0.5px' }}>Reset password</h1>
          <p style={{ fontSize: '15px', color: '#cbd5e1', fontWeight: '500' }}>Enter your email to receive reset instructions</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{
          ...
          <div style={{ marginBottom: '28px' }}>
            <label style={{ display: 'block', fontSize: '14px', fontWeight: '600', marginBottom: '10px', color: '#e0e7ff', letterSpacing: '-0.2px' }}>Email Address</label>
            <input
              type="email"
              value={email}
