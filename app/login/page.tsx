    ...
    <div style={{ background: '#0a0e27', color: '#fff', minHeight: '100vh', fontFamily: 'Inter, sans-serif', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
      ...
      <div style={{ position: 'relative', zIndex: 2, width: '100%', maxWidth: '420px' }}>
        <div style={{ textAlign: 'center', marginBottom: '60px' }}>
          ...
          <h1 style={{ fontSize: '32px', fontWeight: '800', marginBottom: '12px', letterSpacing: '-0.5px' }}>Welcome back</h1>
          <p style={{ fontSize: '15px', color: '#cbd5e1', fontWeight: '500' }}>Sign in to continue learning with Sage</p>
        </div>
        ...
        <div style={{ marginTop: '40px', padding: '16px', background: 'rgba(139, 92, 246, 0.1)', border: '1px solid rgba(139, 92, 246, 0.2)', borderRadius: '12px', fontSize: '12px', color: '#cbd5e1', lineHeight: '1.6', fontWeight: '500' }}>
          <strong style={{ color: '#e0e7ff', display: 'block', marginBottom: '6px' }}>Demo Account</strong>
          Email: <code style={{ background: 'rgba(0,0,0,0.2)', padding: '2px 6px', borderRadius: '4px', color: '#f1f5f9' }}>admin</code>
          <br />
          Password: <code style={{ background: 'rgba(0,0,0,0.2)', padding: '2px 6px', borderRadius: '4px', color: '#f1f5f9' }}>admin123</code>
        </div>
