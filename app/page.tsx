    ...
    <div style={{ background: '#0a0e27', color: '#fff', minHeight: '100vh', fontFamily: 'Inter, sans-serif' }}>
      ...
      <nav style={{ position: 'sticky', top: 0, zIndex: 100, background: 'rgba(10, 14, 39, 0.5)', backdropFilter: 'blur(50px)', borderBottom: '1px solid rgba(139, 92, 246, 0.15)', padding: '20px 20px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', maxWidth: '1400px', margin: '0 auto' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <defs>
              <linearGradient id="logo3d" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" style={{ stopColor: '#ffffff', stopOpacity: 1 }} />
                <stop offset="100%" style={{ stopColor: '#ffffff', stopOpacity: 1 }} />
              </linearGradient>
            </defs>
            {/* Dot */}
            <circle cx="35" cy="30" r="12" fill="url(#logo3d)"/>
            {/* 3D Rounded Bar */}
            {/* Left shadow side */}
            <path d="M 20 55 Q 15 55 15 65 L 15 115 Q 15 125 20 125 L 30 130 Q 28 130 25 130 L 25 65 Q 25 55 30 55 Z" fill="url(#logo3d)" opacity="0.4"/>
            {/* Main front face */}
            <path d="M 30 55 Q 25 55 25 65 L 25 115 Q 25 125 30 125 L 50 125 Q 55 125 55 115 L 55 65 Q 55 55 50 55 Z" fill="url(#logo3d)"/>
            {/* Top highlight */}
            <ellipse cx="40" cy="55" rx="15" ry="4" fill="url(#logo3d)" opacity="0.6"/>
          </svg>
      ...
      <footer style={{ padding: '60px 20px 40px', borderTop: '1px solid rgba(139, 92, 246, 0.2)', textAlign: 'center', color: '#64748b', fontSize: '15px', zIndex: 2, position: 'relative', background: 'linear-gradient(180deg, transparent 0%, rgba(139, 92, 246, 0.05) 100%)' }}>
        <div style={{ marginBottom: '20px' }}>
          <a href="/faq" style={{ color: '#cbd5e1', textDecoration: 'none', fontWeight: '600', marginRight: '24px', transition: 'color 0.3s' }}>FAQ</a>
          <a href="/faq" style={{ color: '#cbd5e1', textDecoration: 'none', fontWeight: '600', transition: 'color 0.3s' }}>Help Center</a>
        </div>
